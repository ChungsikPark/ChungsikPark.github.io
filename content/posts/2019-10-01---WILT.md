...
* ### Margin, Border, Padding (CSS box model)
  ...
  ![css_box_model.jpg](/media/css_box_model.jpg)
 ...
 * Margin -> Clears an area outside the border. The margin is transparent
  ...
  ```
  ( {margin: 10px;} = { margin: 10px 10px 10px 10px;} = {margin-top: 10px; margin-right: 10px; margin-bottom: 10px; margin-left: 10px;} / {위, 오, 아래, 왼} )
  ```
